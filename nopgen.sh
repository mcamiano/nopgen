#!sh
# nopgen.sh: dependancy factoring system
#
...
#
# Sugar Free nopgen.sh: No Temp Files; Never had 'em, never will.
#
# Version 1.0
#
...
AWKPROG="d:/gawk/gawk.exe"
SEDPROG="c:/bin/sed.exe"
CATPROG="cat"
PRPROG="more"
...
export PROTOFILES JUNCBOXES DEMARCSTART DEMARCEND NOPGENHOME NOPGENSCRIPT
export MANPAGE CATPROG PRPROG AWKPROG SEDPROG
...
do
   ...
   if [ ! -f "$file" ]
   then
      echo "$0: $file is not a regular file."
      FatalError=1
   fi
done
